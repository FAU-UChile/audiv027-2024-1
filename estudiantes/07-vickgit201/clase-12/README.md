...
a.1 Implementación de GANs en proyectos reales

a.2 Imágenes

b. Entonces, ¿Qué es una GAN?

b.1 Definición de GANs

b.2 Casos actuales

b.3 Características de una GAN
 
b.4 Arquitectura básica de una GAN

c. Conclusiones

c.1 Resumen de los principales puntos tratados

c.2 Impacto potencial de las GANs en la industria y la investigación

d. Referencias

d.1 Listado de fuentes consultadas y citadas
...
Aquí se importan todas las bibliotecas necesarias:
...
Capas utilizadas dentro del codigo
...
La función tangente hiperbólica (tanh) es una función de activación comúnmente utilizada en capas de salida de generadores en redes generativas (GANs). Esta función produce salidas en el rango [-1, 1] que al normalizar los datos de entrada en el mismo rango, se facilita el aprendizaje del modelo, ya que, los valores de entrada estarán alineados con el rango de salida deseado de la función tanh.
...
Esto es importante porque las operaciones en redes neuronales suelen realizarse de mejor con tipos de datos de punto flotante, ya que proporcionan la precisión necesaria para los cálculos graduales durante el entrenamiento.
...
Este es el discriminador de la GAN, el cual toma una imagen de entrada de tamaño 32x32x32 y produce una predicción de si la imagen es real o generada.
...
# Características de una GAN: Generación de imágenes realistas

Mejora de imágenes y super-resolución;Transferencia de estilo y síntesis de texturas
